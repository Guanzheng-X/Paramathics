...
//
{
    ...
    /*****self write code *****/
    int n = mat.Dim();
    int nz_num = (int)mat().size();
    vector<int> ia = mat.IA();
    vector<int> ja = mat.JA();
    vector<double> a = mat();
    itr_used = 0;
    ...
    rearrange_cr ( n, nz_num, &ia[0], &ja[0], &a[0] );
    
    diagonal_pointer_cr ( n, nz_num, &ia[0], &ja[0], ua );
    
    ilu_cr ( n, nz_num, &ia[0], &ja[0], &a[0], ua, l );
    ...
    {
        ax_cr ( n, nz_num, &ia[0], &ja[0], &a[0], x, r );
        ...
        lus_cr ( n, nz_num, &ia[0], &ja[0], l, ua, r, r );
        ...
        for ( k = 0; k < mr; k++ )
        {
            ...
            ax_cr ( n, nz_num, &ia[0], &ja[0], &a[0], v+k*n, v+(k+1)*n );
            
            lus_cr ( n, nz_num, &ia[0], &ja[0], l, ua, v+(k+1)*n, v+(k+1)*n );
